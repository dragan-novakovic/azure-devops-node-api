...
export class GitApi extends basem.ClientApiBase implements IGitApi {
  ...
  public static readonly RESOURCE_AREA_ID =
    "4e080c62-fa21-4fbc-8fef-2a10a2b38049";
  ...
  public async createAnnotatedTag(
    ...
    return new Promise<GitInterfaces.GitAnnotatedTag>(
      async (resolve, reject) => {
        ...
        try {
          let verData: vsom.ClientVersioningData =
            await this.vsoClient.getVersioningData(
              "6.1-preview.1",
              "git",
          ...
          res = await this.rest.create<GitInterfaces.GitAnnotatedTag>(
            url,
            tagObject,
            options
          );

          let ret = this.formatResponse(
            res.result,
    ...
    return new Promise<GitInterfaces.GitAnnotatedTag>(
      async (resolve, reject) => {
        ...
        try {
          ...
          let res: restm.IRestResponse<GitInterfaces.GitAnnotatedTag>;
          res = await this.rest.get<GitInterfaces.GitAnnotatedTag>(
            url,
            options
          );
  ...
  public async getBlobContent(
    ...
    return new Promise<NodeJS.ReadableStream>(async (resolve, reject) => {
      ...
      try {
        ...
        let accept: string = this.createAcceptHeader(
  ...
  public async getBranch(
    ...
    return new Promise<GitInterfaces.GitBranchStats>(
      async (resolve, reject) => {
        let routeValues: any = {
          project: project,
          repositoryId: repositoryId,
    ...
    return new Promise<GitInterfaces.GitBranchStats[]>(
      async (resolve, reject) => {
        ...
        try {
          ...
          let res: restm.IRestResponse<GitInterfaces.GitBranchStats[]>;
          res = await this.rest.get<GitInterfaces.GitBranchStats[]>(
            url,
            options
          );
    ...
    return new Promise<GitInterfaces.GitBranchStats[]>(
      async (resolve, reject) => {
        ...
        try {
          ...
          let res: restm.IRestResponse<GitInterfaces.GitBranchStats[]>;
          res = await this.rest.create<GitInterfaces.GitBranchStats[]>(
            url,
            searchCriteria,
            options
          );
  ...
  public async getChanges(
    ...
    return new Promise<GitInterfaces.GitCommitChanges>(
      async (resolve, reject) => {
        let routeValues: any = {
          project: project,
          commitId: commitId,
        ...
        try {
          ...
          res = await this.rest.get<GitInterfaces.GitCommitChanges>(
            url,
            options
          );
  ...
  public async updateCherryPickConflict(
    ...
    return new Promise<GitInterfaces.GitConflict>(async (resolve, reject) => {
      ...
      try {
        ...
        let res: restm.IRestResponse<GitInterfaces.GitConflict>;
        res = await this.rest.update<GitInterfaces.GitConflict>(
          url,
          conflict,
          options
        );
  ...
  public async updateCherryPickConflicts(
    ...
    return new Promise<GitInterfaces.GitConflictUpdateResult[]>(
      async (resolve, reject) => {
        let routeValues: any = {
          project: project,
          repositoryId: repositoryId,
        ...
        try {
          ...
          res = await this.rest.update<GitInterfaces.GitConflictUpdateResult[]>(
            url,
            conflictUpdates,
            options
          );
  ...
  public async getCherryPickRelationships(
    ...
    return new Promise<GitInterfaces.GitCommitRef[]>(
      async (resolve, reject) => {
        let routeValues: any = {
          project: project,
  ...
  public async createCherryPick(
    ...
    return new Promise<GitInterfaces.GitCherryPick>(async (resolve, reject) => {
      ...
      try {
        ...
        res = await this.rest.create<GitInterfaces.GitCherryPick>(
          url,
          cherryPickToCreate,
          options
        );
  ...
  public async getCommitDiffs(
    ...
    return new Promise<GitInterfaces.GitCommitDiffs>(
      async (resolve, reject) => {
        let routeValues: any = {
          project: project,
          repositoryId: repositoryId,
        ...
        if (targetVersionDescriptor) {
          ...
          queryValues.targetVersionOptions =
            targetVersionDescriptor.versionOptions;
        }
    ...
    return new Promise<GitInterfaces.GitCommitRef[]>(
      async (resolve, reject) => {
        ...
        try {
          ...
          let res: restm.IRestResponse<GitInterfaces.GitCommitRef[]>;
          res = await this.rest.create<GitInterfaces.GitCommitRef[]>(
            url,
            searchCriteria,
            options
          );
  ...
  public async getDeletedRepositories(
    ...
    return new Promise<GitInterfaces.GitDeletedRepository[]>(
      async (resolve, reject) => {
        let routeValues: any = {
          project: project,
        };
        ...
        try {
          ...
          res = await this.rest.get<GitInterfaces.GitDeletedRepository[]>(
            url,
            options
          );
  ...
  public async getFileDiffs(
    ...
    return new Promise<GitInterfaces.FileDiff[]>(async (resolve, reject) => {
      ...
      try {
        ...
        res = await this.rest.create<GitInterfaces.FileDiff[]>(
          url,
          fileDiffsCriteria,
          options
        );
  ...
  public async getForks(
    ...
    return new Promise<GitInterfaces.GitRepositoryRef[]>(
      async (resolve, reject) => {
        let routeValues: any = {
          project: project,
          repositoryNameOrId: repositoryNameOrId,
        ...
        try {
          ...
          res = await this.rest.get<GitInterfaces.GitRepositoryRef[]>(
            url,
            options
          );
  ...
  public async createForkSyncRequest(
    ...
    return new Promise<GitInterfaces.GitForkSyncRequest>(
      async (resolve, reject) => {
        let routeValues: any = {
          project: project,
          repositoryNameOrId: repositoryNameOrId,
        ...
        try {
          ...
          res = await this.rest.create<GitInterfaces.GitForkSyncRequest>(
            url,
            syncParams,
            options
          );
    ...
    return new Promise<GitInterfaces.GitForkSyncRequest>(
      async (resolve, reject) => {
        ...
        try {
          ...
          let res: restm.IRestResponse<GitInterfaces.GitForkSyncRequest>;
          res = await this.rest.get<GitInterfaces.GitForkSyncRequest>(
            url,
            options
          );
  ...
  public async createImportRequest(
    ...
    return new Promise<GitInterfaces.GitImportRequest>(
      async (resolve, reject) => {
        let routeValues: any = {
          project: project,
          repositoryId: repositoryId,
        ...
        try {
          ...
          res = await this.rest.create<GitInterfaces.GitImportRequest>(
            url,
            importRequest,
            options
          );
    ...
    return new Promise<GitInterfaces.GitImportRequest>(
      async (resolve, reject) => {
        ...
        try {
          ...
          let res: restm.IRestResponse<GitInterfaces.GitImportRequest>;
          res = await this.rest.get<GitInterfaces.GitImportRequest>(
            url,
            options
          );
    ...
    return new Promise<GitInterfaces.GitImportRequest>(
      async (resolve, reject) => {
        ...
        try {
          ...
          let res: restm.IRestResponse<GitInterfaces.GitImportRequest>;
          res = await this.rest.update<GitInterfaces.GitImportRequest>(
            url,
  ...
  public async getItemsBatch(
    ...
    return new Promise<GitInterfaces.GitItem[][]>(async (resolve, reject) => {
      ...
      try {
        ...
        let res: restm.IRestResponse<GitInterfaces.GitItem[][]>;
        res = await this.rest.create<GitInterfaces.GitItem[][]>(
          url,
          requestData,
          options
        );
  ...
  public async createMergeRequest(
    ...
    return new Promise<GitInterfaces.GitMerge>(async (resolve, reject) => {
      ...
      try {
        ...
        res = await this.rest.create<GitInterfaces.GitMerge>(
          url,
          mergeParameters,
          options
        );
  ...
  public async createAttachment(
    ...
    return new Promise<GitInterfaces.Attachment>(async (resolve, reject) => {
      ...
      try {
        ...
        res = await this.rest.uploadStream<GitInterfaces.Attachment>(
          "POST",
          url,
          contentStream,
          options
  ...
  public async getPullRequestIterationChanges(
    ...
    return new Promise<GitInterfaces.GitPullRequestIterationChanges>(
      async (resolve, reject) => {
        let routeValues: any = {
          project: project,
          repositoryId: repositoryId,
        ...
        try {
          ...
          res =
            await this.rest.get<GitInterfaces.GitPullRequestIterationChanges>(
              url,
              options
            );
  ...
  public async getPullRequestIteration(
    ...
    return new Promise<GitInterfaces.GitPullRequestIteration>(
      async (resolve, reject) => {
        let routeValues: any = {
          project: project,
          repositoryId: repositoryId,
        ...
        try {
          ...
          res = await this.rest.get<GitInterfaces.GitPullRequestIteration>(
            url,
            options
          );
  ...
  public async createPullRequestIterationStatus(
    ...
    return new Promise<GitInterfaces.GitPullRequestStatus>(
      async (resolve, reject) => {
        let routeValues: any = {
          project: project,
          repositoryId: repositoryId,
        ...
        try {
          ...
          res = await this.rest.create<GitInterfaces.GitPullRequestStatus>(
            url,
            status,
            options
          );
    ...
    return new Promise<GitInterfaces.GitPullRequestStatus>(
      async (resolve, reject) => {
        ...
        try {
          ...
          let res: restm.IRestResponse<GitInterfaces.GitPullRequestStatus>;
          res = await this.rest.get<GitInterfaces.GitPullRequestStatus>(
            url,
            options
          );
  ...
  public async createPullRequestLabel(
    ...
    return new Promise<TfsCoreInterfaces.WebApiTagDefinition>(
      async (resolve, reject) => {
        let routeValues: any = {
          project: project,
          repositoryId: repositoryId,
        ...
        try {
          ...
          res = await this.rest.create<TfsCoreInterfaces.WebApiTagDefinition>(
            url,
            label,
            options
          );
    ...
    return new Promise<TfsCoreInterfaces.WebApiTagDefinition>(
      async (resolve, reject) => {
        ...
        try {
          ...
          let res: restm.IRestResponse<TfsCoreInterfaces.WebApiTagDefinition>;
          res = await this.rest.get<TfsCoreInterfaces.WebApiTagDefinition>(
            url,
            options
          );
  ...
  public async getPullRequestQuery(
    ...
    return new Promise<GitInterfaces.GitPullRequestQuery>(
      async (resolve, reject) => {
        let routeValues: any = {
          project: project,
          repositoryId: repositoryId,
        ...
        try {
          ...
          res = await this.rest.create<GitInterfaces.GitPullRequestQuery>(
            url,
            queries,
            options
          );
  ...
  public async createPullRequestReviewer(
    ...
    return new Promise<GitInterfaces.IdentityRefWithVote>(
      async (resolve, reject) => {
        let routeValues: any = {
          project: project,
          repositoryId: repositoryId,
        ...
        try {
          ...
          res = await this.rest.replace<GitInterfaces.IdentityRefWithVote>(
            url,
            reviewer,
            options
          );
    ...
    return new Promise<GitInterfaces.IdentityRefWithVote[]>(
      async (resolve, reject) => {
        ...
        try {
          ...
          let res: restm.IRestResponse<GitInterfaces.IdentityRefWithVote[]>;
          res = await this.rest.create<GitInterfaces.IdentityRefWithVote[]>(
            url,
            reviewers,
            options
          );
    ...
    return new Promise<GitInterfaces.IdentityRefWithVote>(
      async (resolve, reject) => {
        ...
        try {
          ...
          let res: restm.IRestResponse<GitInterfaces.IdentityRefWithVote>;
          res = await this.rest.get<GitInterfaces.IdentityRefWithVote>(
            url,
            options
          );
    ...
    return new Promise<GitInterfaces.IdentityRefWithVote>(
      async (resolve, reject) => {
        ...
        try {
          ...
          let res: restm.IRestResponse<GitInterfaces.IdentityRefWithVote>;
          res = await this.rest.update<GitInterfaces.IdentityRefWithVote>(
            url,
            reviewer,
            options
          );
  ...
  public async getPullRequestById(
    ...
    return new Promise<GitInterfaces.GitPullRequest>(
      async (resolve, reject) => {
        let routeValues: any = {
          project: project,
          pullRequestId: pullRequestId,
    ...
    return new Promise<GitInterfaces.GitPullRequest[]>(
      async (resolve, reject) => {
        ...
        try {
          ...
          let res: restm.IRestResponse<GitInterfaces.GitPullRequest[]>;
          res = await this.rest.get<GitInterfaces.GitPullRequest[]>(
            url,
            options
          );
    ...
    return new Promise<GitInterfaces.GitPullRequest>(
      async (resolve, reject) => {
        ...
        try {
          ...
          let res: restm.IRestResponse<GitInterfaces.GitPullRequest>;
          res = await this.rest.create<GitInterfaces.GitPullRequest>(
            url,
    ...
    return new Promise<GitInterfaces.GitPullRequest>(
      async (resolve, reject) => {
        ...
        try {
          ...
          let res: restm.IRestResponse<GitInterfaces.GitPullRequest>;
          res = await this.rest.update<GitInterfaces.GitPullRequest>(
            url,
  ...
  public async createComment(
    ...
    return new Promise<GitInterfaces.Comment>(async (resolve, reject) => {
      ...
      try {
        ...
        res = await this.rest.create<GitInterfaces.Comment>(
          url,
          comment,
          options
        );
  ...
  public async updateComment(
    ...
    return new Promise<GitInterfaces.Comment>(async (resolve, reject) => {
      ...
      try {
        ...
        let res: restm.IRestResponse<GitInterfaces.Comment>;
        res = await this.rest.update<GitInterfaces.Comment>(
          url,
          comment,
          options
        );
    ...
    return new Promise<GitInterfaces.GitPullRequestCommentThread>(
      async (resolve, reject) => {
        ...
        try {
          ...
          res =
            await this.rest.create<GitInterfaces.GitPullRequestCommentThread>(
              url,
              commentThread,
              options
            );
    ...
    return new Promise<GitInterfaces.GitPullRequestCommentThread>(
      async (resolve, reject) => {
        ...
        try {
          ...
          let res: restm.IRestResponse<GitInterfaces.GitPullRequestCommentThread>;
          res = await this.rest.get<GitInterfaces.GitPullRequestCommentThread>(
            url,
            options
          );
    ...
    return new Promise<GitInterfaces.GitPullRequestCommentThread[]>(
      async (resolve, reject) => {
        ...
        try {
          ...
          let res: restm.IRestResponse<
            GitInterfaces.GitPullRequestCommentThread[]
          >;
          res = await this.rest.get<
            GitInterfaces.GitPullRequestCommentThread[]
          >(url, options);
    ...
    return new Promise<GitInterfaces.GitPullRequestCommentThread>(
      async (resolve, reject) => {
        ...
        try {
          ...
          let res: restm.IRestResponse<GitInterfaces.GitPullRequestCommentThread>;
          res =
            await this.rest.update<GitInterfaces.GitPullRequestCommentThread>(
              url,
              commentThread,
              options
            );
  ...
  public async restoreRepositoryFromRecycleBin(
    ...
    return new Promise<GitInterfaces.GitRepository>(async (resolve, reject) => {
      ...
      try {
        ...
        res = await this.rest.update<GitInterfaces.GitRepository>(
          url,
          repositoryDetails,
          options
        );
  ...
  public async updateRef(
    ...
    return new Promise<GitInterfaces.GitRef>(async (resolve, reject) => {
      ...
      try {
        ...
        let res: restm.IRestResponse<GitInterfaces.GitRef>;
        res = await this.rest.update<GitInterfaces.GitRef>(
          url,
          newRefInfo,
          options
        );
  ...
  public async updateRefs(
    ...
    return new Promise<GitInterfaces.GitRefUpdateResult[]>(
      async (resolve, reject) => {
        let routeValues: any = {
          project: project,
          repositoryId: repositoryId,
        ...
        try {
          ...
          res = await this.rest.create<GitInterfaces.GitRefUpdateResult[]>(
            url,
            refUpdates,
            options
          );
  ...
  public async createFavorite(
    ...
    return new Promise<GitInterfaces.GitRefFavorite>(
      async (resolve, reject) => {
        let routeValues: any = {
          project: project,
        };
        ...
        try {
          ...
          res = await this.rest.create<GitInterfaces.GitRefFavorite>(
            url,
            favorite,
            options
          );
    ...
    return new Promise<GitInterfaces.GitRefFavorite[]>(
      async (resolve, reject) => {
        ...
        try {
          ...
          let res: restm.IRestResponse<GitInterfaces.GitRefFavorite[]>;
          res = await this.rest.get<GitInterfaces.GitRefFavorite[]>(
            url,
            options
          );
  ...
  public async createRepository(
    ...
    return new Promise<GitInterfaces.GitRepository>(async (resolve, reject) => {
      ...
      try {
        ...
        let res: restm.IRestResponse<GitInterfaces.GitRepository>;
        res = await this.rest.create<GitInterfaces.GitRepository>(
          url,
  ...
  public async getRepositories(
    ...
    return new Promise<GitInterfaces.GitRepository[]>(
      async (resolve, reject) => {
        let routeValues: any = {
          project: project,
        };
        ...
        try {
          ...
          let res: restm.IRestResponse<GitInterfaces.GitRepository[]>;
          res = await this.rest.get<GitInterfaces.GitRepository[]>(
            url,
            options
          );
  ...
  public async createRevert(
    ...
    return new Promise<GitInterfaces.GitRevert>(async (resolve, reject) => {
      ...
      try {
        ...
        res = await this.rest.create<GitInterfaces.GitRevert>(
          url,
          revertToCreate,
          options
        );
  ...
  public async createCommitStatus(
    ...
    return new Promise<GitInterfaces.GitStatus>(async (resolve, reject) => {
      ...
      try {
        ...
        res = await this.rest.create<GitInterfaces.GitStatus>(
          url,
  ...
  public async getSuggestions(
    ...
    return new Promise<GitInterfaces.GitSuggestion[]>(
      async (resolve, reject) => {
        let routeValues: any = {
          project: project,
          repositoryId: repositoryId,
        ...
        try {
          ...
          res = await this.rest.get<GitInterfaces.GitSuggestion[]>(
            url,
            options
          );
